...
#define	SI10_CLK_SRC			0x0200 //Trigger source
...
struct	SI10Data {
	...
	int		nGPIOIrqMask;			// Which bits generate an interrupt
	int		nGPIOIrqCount;			// Increment counter at IRQ level in Device drive
	BOOLEAN	bGPIOEvent;				// Generate an Event
	int		nGeneralInput;
	int		nGeneralOutput;
