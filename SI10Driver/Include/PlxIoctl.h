...
#define IOCTL_SI10_SHARE_USER_STRUCT			CTL_CODE(       FILE_DEVICE_UNKNOWN, 0x839,	METHOD_NEITHER,	 FILE_ANY_ACCESS)
#define IOCTL_SI10_LOAD_FPGA_CODE				CTL_CODE(       FILE_DEVICE_UNKNOWN, 0x840,	METHOD_NEITHER,	 FILE_ANY_ACCESS)
#define IOCTL_SI10_ENABLE_INTERRUPT_CALLBACK	CTL_CODE(       FILE_DEVICE_UNKNOWN, 0x841,	METHOD_NEITHER,	 FILE_ANY_ACCESS)
#define IOCTL_SI10_SHARE_TIMESLOT_STRUCT		CTL_CODE(       FILE_DEVICE_UNKNOWN, 0x842,	METHOD_NEITHER,	 FILE_ANY_ACCESS)
#define IOCTL_SI10_SHARE_UT_USER_STRUCT			CTL_CODE(       FILE_DEVICE_UNKNOWN, 0x843,	METHOD_NEITHER,	 FILE_ANY_ACCESS)
#define IOCTL_SI10_FREE_UT_USER_STRUCT			CTL_CODE(       FILE_DEVICE_UNKNOWN, 0x844,	METHOD_NEITHER,	 FILE_ANY_ACCESS)
