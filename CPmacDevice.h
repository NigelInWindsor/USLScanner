...
//		InvokeHelper(0x13, DISPATCH_METHOD, VT_EMPTY, NULL, parms, d, scale, pVal);
	...
	void SetQuickGather(long dwDevice, long mask, BOOL bEnable, BOOL * pbSuccess)
	{
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_BOOL VTS_PBOOL ;
		InvokeHelper(0x87, DISPATCH_METHOD, VT_EMPTY, NULL, parms, dwDevice, mask, bEnable, pbSuccess);
	}
	void SetQuickGatherWithDirectCurrent(long dwDevice, long mask, BOOL bEnable, BOOL * pbSuccess)
	{
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_BOOL VTS_PBOOL ;
		InvokeHelper(0x88, DISPATCH_METHOD, VT_EMPTY, NULL, parms, dwDevice, mask, bEnable, pbSuccess);
	}
	...
	void DPRRotBufInit(long dwDevice, long bufnum, long new_size, BOOL * pbSuccess)
	{
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 VTS_PBOOL ;
		InvokeHelper(0xde, DISPATCH_METHOD, VT_EMPTY, NULL, parms, dwDevice, bufnum, new_size, pbSuccess);
	}
