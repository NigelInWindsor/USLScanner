...
RETURN_CODE AlazarParseFPGAName(const char *FullName,
                                char *Name,
                                U32 *Type,
                                U32 *MemSize,
                                U32 *MajVer,
...
RETURN_CODE AlazarInputControl(
    HANDLE h, U8 Channel, U32 Coupling, U32 InputRange, U32 Impedance);
RETURN_CODE AlazarInputControlEx(
    HANDLE h, U32 Channel, U32 Coupling, U32 InputRange, U32 Impedance);
RETURN_CODE
...
RETURN_CODE AlazarGetTriggerAddress(HANDLE h,
                                    U32 Record,
                                    U32 *TriggerAddress,
...
RETURN_CODE AlazarSetTriggerOperation(HANDLE h,
                                      ...
                                      U32 TriggerEngine1 /*j,K*/,
                                      U32 Source1,
                                      U32 Slope1,
                                      U32 Level1,
                                      U32 TriggerEngine2 /*j,K*/,
                                      U32 Source2,
                                      U32 Slope2,
                                      U32 Level2);
RETURN_CODE
AlazarGetTriggerTimestamp(HANDLE h, U32 Record, U64 *Timestamp_samples);
RETURN_CODE AlazarSetTriggerOperationForScanning(HANDLE h,
                                                 U32 slope,
                                                 U32 level,
                                                 U32 options);
...
// *****************************************************************************
// OEM API Functions
RETURN_CODE AlazarStreamCapture(HANDLE h,
                                void *Buffer,
                                U32 BufferSize,
                                U32 DeviceOption,
                                U32 ChannelSelect,
...
RETURN_CODE AlazarHyperDisp(HANDLE h,
                            void *Buffer,
                            U32 BufferSize,
                            U8 *ViewBuffer,
                            U32 ViewBufferSize,
...
RETURN_CODE AlazarFastPRRCapture(HANDLE h,
                                 void *Buffer,
                                 U32 BufferSize,
                                 U32 DeviceOption,
                                 U32 ChannelSelect,
...
RETURN_CODE
AlazarSetCaptureClock(HANDLE h, U32 Source, U32 Rate, U32 Edge, U32 Decimation);
...
//              B And Ext = 6
//              Timeout   = 7
U32 AlazarGetWhoTriggeredBySystemHandle(HANDLE systemHandle,
                                        U32 brdNum,
                                        U32 recNum);
...
RETURN_CODE AlazarStartAutoDMA(HANDLE h,
                               void *Buffer1,
                               U32 UseHeader,
                               U32 ChannelSelect,
                               long TransferOffset,
                               U32 TransferLength,
                               long RecordsPerBuffer,
                               long RecordCount,
                               ...
                               U32 *r3,
                               U32 *r4);
RETURN_CODE AlazarGetNextAutoDMABuffer(HANDLE h,
                                       void *Buffer1,
                                       void *Buffer2,
                                       long *WhichOne,
                                       ...
                                       U32 *r4);
RETURN_CODE AlazarGetNextBuffer(HANDLE h,
                                void *Buffer1,
                                void *Buffer2,
                                long *WhichOne,
                                long *RecordsTransfered,
...
RETURN_CODE AlazarAbortAutoDMA(HANDLE h,
                               void *Buffer,
                               AUTODMA_STATUS *error,
                               U32 r1,
                               U32 r2,
                               U32 *r3,
                               U32 *r4);
U32 AlazarGetAutoDMAHeaderValue(HANDLE h,
                                U32 Channel,
                                void *DataBuffer,
                                U32 Record,
                                U32 Parameter,
                                AUTODMA_STATUS *error);
float AlazarGetAutoDMAHeaderTimeStamp(
    HANDLE h, U32 Channel, void *DataBuffer, U32 Record, AUTODMA_STATUS *error);
void *AlazarGetAutoDMAPtr(HANDLE h,
                          U32 DataOrHeader,
                          U32 Channel,
                          void *DataBuffer,
                          U32 Record,
...
RETURN_CODE
AlazarBeforeAsyncRead(HANDLE hBoard,
                      U32 uChannelSelect,
...
RETURN_CODE
AlazarPostAsyncBuffer(HANDLE hDevice, void *pBuffer, U32 uBufferLength_bytes);

RETURN_CODE
AlazarWaitAsyncBufferComplete(HANDLE hDevice, void *pBuffer, U32 uTimeout_ms);

RETURN_CODE
AlazarWaitNextAsyncBufferComplete(HANDLE hDevice,
                                  void *pBuffer,
                                  U32 uBufferLength_bytes,
                                  U32 uTimeout_ms);

RETURN_CODE
AlazarCreateStreamFileA(HANDLE hDevice, const char *pszFilePath);

RETURN_CODE
AlazarCreateStreamFileW(HANDLE hDevice, const WCHAR *pszFilePath);
...
//
// DAC CONTROL API
RETURN_CODE AlazarDACSetting(HANDLE h,
                             U32 SetGet,
                             U32 OriginalOrModified,
                             U8 Channel,
                             U32 DACNAME,
                             U32 Coupling,
                             U32 InputRange,
...
RETURN_CODE
AlazarConfigureSampleSkipping(HANDLE hBoard,
                              U32 uMode,
...
RETURN_CODE
AlazarCoprocessorDownloadW(HANDLE hBoard, WCHAR *pszFileName, U32 uOptions);
...
RETURN_CODE
AlazarGetBoardRevision(HANDLE hBoard, U8 *Major, U8 *Minor);

// FPGA averaging

RETURN_CODE
AlazarConfigureRecordAverage(HANDLE hBoard,
                             U32 uMode,
                             U32 uSamplesPerRecord,
...
RETURN_CODE
AlazarFreeBufferU8(HANDLE hBoard, U8 *pBuffer);

RETURN_CODE AlazarConfigureLSB(HANDLE hBoard, U32 uValueLsb0, U32 uValueLsb1);

U16 *AlazarAllocBufferU16(HANDLE hBoard, U32 uSampleCount);

RETURN_CODE
AlazarFreeBufferU16(HANDLE hBoard, U16 *pBuffer);
