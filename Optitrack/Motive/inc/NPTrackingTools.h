...
namespace Core
{
    ...
    public:
     //   typedef unsigned long long int uint64;
        ...
        cUID( uint64_t high, uint64_t low ) : mHighBits( high ), mLowBits( low ) { }
        ...
        /// </summary>
        void            SetValue( uint64_t highBits, uint64_t lowBits ) { mHighBits = highBits; mLowBits = lowBits; }

        /// <summary>Get the low 64 bits of the UID.</summary>
        uint64_t          LowBits() const { return mLowBits; }

        /// <summary>Get the high 64 bits of the UID.</summary>
        uint64_t          HighBits() const { return mHighBits; }
