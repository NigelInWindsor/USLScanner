...
void CResizableSheet::PresetLayout()
{
	...
	{	//Added by NJG to accomodate toolbars
		if(m_bToolBar==TRUE) {
			AddAnchor(AFX_IDC_TAB_CONTROL, TOP_LEFT, BOTTOM_RIGHT,CSize(0,GetSystemMetrics(SM_CYMENU)+3));
		} else {
			AddAnchor(AFX_IDC_TAB_CONTROL, TOP_LEFT, BOTTOM_RIGHT,CSize(0,+3));
		}
	}
