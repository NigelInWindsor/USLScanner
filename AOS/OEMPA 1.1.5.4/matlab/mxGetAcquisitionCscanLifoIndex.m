function [FifoIndex, Cycle, Sequence] = mxGetAcquisitionCscanLifoIndex(deviceId, cycles)
% INPUT PARAMETER
...
if nargout>=3
	[FifoIndex, Cycle, Sequence] = utCmd(deviceId,'mxGetAcquisitionCscanLifoIndex', cycles);
elseif nargout>=2
	[FifoIndex, Cycle] = utCmd(deviceId,'mxGetAcquisitionCscanLifoIndex', cycles);
	Sequence = [];
elseif nargout>=1
