...
SetupFileName = 'C:\Users\Public\Share\matrix\ExampleSingle2.txt';
WizardFileName = 'C:\Users\Public\Share\matrix\WizardSingle2.txt';
...
if(mxToolboxIsRunning())
    ...
    if (0 && (exist(WizardFileName, 'file') == 2))
        ...
        mxSetToolboxParameter('OEMPA_system\WizardSystem\WizardSpecimen\Radius=100.0 mm');
        ...
        mxSetToolboxParameter('OEMPA_channel_0\Channels\Probe:100\Scan:100\WizardScan\VectorStop\Angle=70.0 deg');
        ...
        mxSetToolboxParameter('OEMPA_channel_0\Channels\Probe:100\Scan:100\WizardScan\VectorStep\Angle=5.0 deg');
