function [ret,setGain] = mxSetGainDigital(deviceId,nCycle,gainValue)
% INPUT PARAMETER
%deviceId : identification number of the device.
%nCycle : cycle to changed
%gainValue : new Digital gain value
% OUTPUT
...
[ret,setGain] = utCmd(deviceId,'mxSetGainDigital',[nCycle,gainValue]);